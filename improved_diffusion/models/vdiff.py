...
class Unet3D(nn.Module):
    def __init__(
        ...
        temporal_attn = lambda dim: EinopsToAndFrom('b c f l', 'b l f c', RelAttention(dim, heads = attn_heads, dim_head = attn_dim_head, rotary_emb = rotary_emb))
