...
class UNet2(nn.Module):
    ...
    def __init__(self, image_channels: int = 3, n_channels: int = 64,
                 ...
                 n_blocks: int = 2, model_out_channels = None):
        """
        ...
        * `n_blocks` is the number of `UpDownBlocks` at each resolution
        ...
        if model_out_channels==None:
            model_out_channels = image_channels
        ...
        self.act = Swish()
        self.final = nn.Conv2d(in_channels, model_out_channels, kernel_size=(3, 3), padding=(1, 1))
