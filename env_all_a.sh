...
export OPENAI_LOGDIR=/screamlab/home/eri24816/improved-diffusion/log/env_all_a
...
export TRAIN_FLAGS="--lr 2e-05 --batch_size 2 --schedule_sampler loss-second-moment --save_interval 50000 --log_interval 200"