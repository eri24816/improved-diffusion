...
export OPENAI_LOGDIR=~/improved-diffusion/log/1b_ae_tw

export MODEL_FLAGS="--num_channels 128 --learn_sigma True --segment_length 32 --latent_size 64"
export DIFFUSION_FLAGS="--diffusion_steps 1000 --noise_schedule cosine"
export TRAIN_FLAGS="--lr 2e-05 --batch_size 16 --schedule_sampler loss-second-moment --save_interval 50000 --log_interval 200"
